...
public class FixChain {
 ...
 String substrateNet;
    ...
    public FixChain(ArrayList<Vertex> Vertices, ArrayList<graphEdge> Edges, ArrayList<functionnode> VNFs,String file, int BW, String subNetwork) {
...
//        }
      ...
      //  priorityDFS=dfsCase.getPriorityListNodes();
       ...
       priorityDFS= topSort.topologicalSort();
        ...
        findShortestPath SP_DFS=new findShortestPath(Vertices, Edges, VNFs,this.substrateNet);
...
//        }
       ...
       // //System.out.println("Last element is:");
        ...
        if(returnedFromSP_DFS.isEmpty()){
         System.out.println("################################################Request is rejected: list to check is empty: no path is found: Fix Chain#######################################");
          flagTop = false;
          int toret = 0;
          return toret;
        }
